...
abstract public class NetworkLikelihoodCore {
     ...
     * calculation differs-*
     */
    abstract public void calculatePartials(RecombinationNetworkEdge edge1, RecombinationNetworkEdge edge2, RecombinationNetworkEdge edge3);
...
//    abstract LikelihoodCore feelsGood();
    ...
    abstract public void calculatePartialsRecombination(RecombinationNetworkEdge edge1, RecombinationNetworkEdge edge3);
}
