...
public class RecombinationAlignment extends Map<String> {
     ...
     * at some point. Use {@link #RecombinationAlignment(List, String)} instead.
     */
    @Deprecated
    public RecombinationAlignment(List<Sequence> sequences, Integer stateCount, String dataType) {
     ...
     * @param dataType
     */
    public RecombinationAlignment(List<Sequence> sequences, String dataType) {
    ...
    static String getSequence(RecombinationAlignment data, int taxonIndex) {
